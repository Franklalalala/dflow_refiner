...
if __name__ == "__main__":
    input_root = os.path.abspath('./dummy_input')
    input_art = upload_artifact(Path(input_root))

    # Single private auxiliary
    # ============================================================================
    os.makedirs('sgl_pvt', exist_ok=True)
    os.chdir('sgl_pvt')
    ...
    os.chdir('./..')
    sgl_pvt_art = upload_artifact(Path('sgl_pvt'))
    ...
    download_artifact(artifact=step_end.outputs.artifacts['out_workbase'], path=r'./output_files/single_private')
    # ===============================================================================
    ...
    # ============================================================================
    os.makedirs('sgl_pbc', exist_ok=True)
    os.chdir('sgl_pbc')
    for an_input in os.listdir(input_root):
        a_name = os.path.splitext(an_input)[0]
        shutil.copy(src=os.path.join(input_root, an_input), dst=a_name)
    os.chdir('./..')
    sgl_pbc_art = upload_artifact(Path('sgl_pbc'))
    ...
    download_artifact(artifact=step_end.outputs.artifacts['out_workbase'], path=r'./output_files/single_public')
    # ===============================================================================


    # Multiple private auxiliary
    # ============================================================================
    os.makedirs('multi_pvt', exist_ok=True)
    os.chdir('multi_pvt')
    ...
    multi_pvt_art = upload_artifact(Path('multi_pvt'))
    ...
    download_artifact(artifact=step_end.outputs.artifacts['out_workbase'], path=r'./output_files/multiple_private')
    # ===============================================================================
    ...
    mixed_art = upload_artifact(Path('mixed'))
    ...
    download_artifact(artifact=step_end.outputs.artifacts['out_workbase'], path=r'./output_files/Mixed')
    # ===============================================================================
