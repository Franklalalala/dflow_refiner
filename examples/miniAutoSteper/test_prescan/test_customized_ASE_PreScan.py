...
from dflow_refiner.miniAutoSteper_op import customizedASEPreSan
...
if __name__ == "__main__":
    ...
    ase_prescan = Step(name='ase-prescan',
                       template=PythonOPTemplate(op_class=customizedASEPreSan,
                                                 image="franklalalala/py_autorefiner",
                                                 command=r'/home/mkliu/anaconda3/envs/molnet/bin/python3.8'),
                       artifacts={'workbase': src_dir},
                       parameters={'min_e_gap': 0.005},
    ...
    download_artifact(artifact=step_end_0.outputs.artifacts['out_cooked'], path=r'./output_files_customized/')
    download_artifact(artifact=step_end_0.outputs.artifacts['info'], path=r'./output_files_customized/')
